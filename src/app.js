...
// Point your cron job (e.g. cron-job.org) to GET /ping every 5–10 minutes.
// Open /ping in a browser to confirm the server is being kept alive.
let _pingCount = 0;
...
app.get('/ping', (req, res) => {
  ...
  // Plain-text/JSON for the cron job health check
...
<body>
  <div class="card">
    ...
    <div class="row">
      <span class="label">Last Pinged</span>
      <span class="value">${_lastPinged.toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' })}</span>
    </div>
    <div class="row">
      <span class="label">Total Pings</span>
      <span class="value">${_pingCount}</span>
    </div>
    <div class="row">
    ...
    <div class="row">
      ...
      <span class="value">${startedAt.toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' })}</span>
    </div>
    <div class="row">
